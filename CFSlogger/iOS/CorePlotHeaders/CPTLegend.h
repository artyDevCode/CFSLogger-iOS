 ...
 **/
-(NSString *)legend:(CPTLegend *)legend shouldDrawSwatchAtIndex:(NSUInteger)idx forPlot:(CPTPlot *)plot inRect:(CGRect)rect inContext:(CGContextRef)context;
...
/// @name Layout
/// @{
@property (nonatomic, readonly, assign) NSString layoutChanged;
...
@property (nonatomic, readwrite, assign) NSString equalRows;
@property (nonatomic, readwrite, assign) NSString equalColumns;
