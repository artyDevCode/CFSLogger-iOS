...
/// @{
-(NSString *)contains:(NSDecimal)number;
-(NSString *)containsDouble:(double)number;
-(NSString *)isEqualToRange:(CPTPlotRange *)otherRange;
-(NSString *)containsRange:(CPTPlotRange *)otherRange;
-(NSString *)intersectsRange:(CPTPlotRange *)otherRange;
/// @}
