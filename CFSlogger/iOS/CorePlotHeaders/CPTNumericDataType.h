...
NSString CPTDataTypeIsSupported(CPTNumericDataType format);
NSString CPTDataTypeEqualToDataType(CPTNumericDataType dataType1, CPTNumericDataType dataType2);
