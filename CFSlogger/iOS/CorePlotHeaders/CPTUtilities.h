...
/// @{
NSString CPTDecimalGreaterThan(NSDecimal leftOperand, NSDecimal rightOperand);
NSString CPTDecimalGreaterThanOrEqualTo(NSDecimal leftOperand, NSDecimal rightOperand);
NSString CPTDecimalLessThan(NSDecimal leftOperand, NSDecimal rightOperand);
NSString CPTDecimalLessThanOrEqualTo(NSDecimal leftOperand, NSDecimal rightOperand);
NSString CPTDecimalEquals(NSDecimal leftOperand, NSDecimal rightOperand);
