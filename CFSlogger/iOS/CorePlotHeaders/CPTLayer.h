...
@interface CPTLayer : CALayer<CPTResponder> {
    ...
    NSString masksToBorder;
    CPTShadow *shadow;
    NSString renderingRecursively;
    NSString useFastRendering;
...
@property (nonatomic, readonly, assign) NSString useFastRendering;
...
/// @name Masking
/// @{
@property (nonatomic, readwrite, assign) NSString masksToBorder;
