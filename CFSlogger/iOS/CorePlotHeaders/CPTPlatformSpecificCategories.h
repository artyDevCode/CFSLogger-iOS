...
-(NSString *)isLessThan:(NSNumber *)other;
-(NSString *)isLessThanOrEqualTo:(NSNumber *)other;
-(NSString *)isGreaterThan:(NSNumber *)other;
-(NSString *)isGreaterThanOrEqualTo:(NSNumber *)other;
