 ...
 **/
-(NSString *)pointingDeviceDownEvent:(CPTNativeEvent *)event atPoint:(CGPoint)interactionPoint;
 ...
 *  @return Whether the event was handled or not.
 **/
-(NSString *)pointingDeviceUpEvent:(CPTNativeEvent *)event atPoint:(CGPoint)interactionPoint;
 ...
 *  @return Whether the event was handled or not.
 **/
-(NSString *)pointingDeviceDraggedEvent:(CPTNativeEvent *)event atPoint:(CGPoint)interactionPoint;
 ...
 *  @return Whether the event was handled or not.
 **/
-(NSString *)pointingDeviceCancelledEvent:(CPTNativeEvent *)event;
/// @}
