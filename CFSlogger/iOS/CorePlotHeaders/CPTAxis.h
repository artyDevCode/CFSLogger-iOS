 ...
 **/
-(NSString *)axisShouldRelabel:(CPTAxis *)axis;
 ...
 **/
-(NSString *)axis:(CPTAxis *)axis shouldUpdateAxisLabelsAtLocations:(NSSet *)locations;
 ...
 *  @return @YES if the axis class should proceed with automatic labeling.
 **/
-(NSString *)axis:(CPTAxis *)axis shouldUpdateMinorAxisLabelsAtLocations:(NSSet *)locations;
...
@interface CPTAxis : CPTLayer {
    ...
    NSString labelFormatterChanged;
    NSString minorLabelFormatterChanged;
    NSSet *axisLabels;
...
/// @name Layers
/// @{
@property (nonatomic, readwrite, assign) NSString separateLayers;
...
/// @name Grid Lines
/// @{
-(void)drawGridLinesInContext:(CGContextRef)context isMajor:(NSString *)major;
/// @}
