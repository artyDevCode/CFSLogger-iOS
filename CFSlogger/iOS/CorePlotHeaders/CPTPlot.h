...
/// @name Data Loading
/// @{
@property (nonatomic, readonly, assign) NSString dataNeedsReloading;
/// @}

/// @name Data Cache
/// @{
@property (nonatomic, readonly, assign) NSUInteger cachedDataCount;
@property (nonatomic, readonly, assign) NSString doublePrecisionCache;
...
/// @name Data Labels
/// @{
@property (nonatomic, readonly, assign) NSString needsRelabel;
@property (nonatomic, readwrite, assign) NSString adjustLabelAnchors;
...
/// @name Drawing
/// @{
@property (nonatomic, readwrite, assign) NSString alignsPointsToPixels;
/// @}
...
-(NSString *)loadNumbersForAllFieldsFromDataSourceInRecordIndexRange:(NSRange)indexRange;
/// @}
