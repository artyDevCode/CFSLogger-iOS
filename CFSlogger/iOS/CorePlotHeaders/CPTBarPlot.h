...
@interface CPTBarPlot : CPTPlot {
    ...
    NSDecimal baseValue;
    NSString barsAreHorizontal;
    NSString barBasesVary;
    NSString barWidthsAreInViewCoordinates;
    CPTPlotRange *plotRange;
}

/// @name Appearance
/// @{
@property (nonatomic, readwrite, assign) NSString barWidthsAreInViewCoordinates;
...
@property (nonatomic, readwrite, assign) NSString barsAreHorizontal;
@property (nonatomic, readwrite, assign) NSDecimal baseValue;
@property (nonatomic, readwrite, assign) NSString barBasesVary;
...
/// @{
+(CPTBarPlot *)tubularBarPlotWithColor:(CPTColor *)color horizontalBars:(NSString *)horizontal;
/// @}
