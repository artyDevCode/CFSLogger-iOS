...
-(void)markDates:(NSArray *)dates {
    ...
    for (int i = 0; i<[dates count]; i++) {
        ...
        [colors addObject:[UIColor colorWithName:@"red"]];
    }
...
- (void)drawRect:(CGRect)rect
{
  ...
  //  [formatter release];
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithName:@"red"].CGColor);
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithName:@"gray"].CGColor);  //black
                                  // [UIColor colorWithHexString:@"0x383838"].CGColor);
    for (int i =0; i<[weekdays count]; i++) {
        NSString *weekdayValue = (NSString *)[weekdays objectAtIndex:i];
        UIFont *font = [UIFont fontWithName:@"Helvetica Neue" size:14]; //carlos
    ...
    CGContextSetFillColorWithColor(context, [UIColor whiteColor].CGColor); //[UIColor colorWithHexString:@"0xf3f3f3"].CGColor);
    ...
    //Grid dark lines
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithName:@"whitesmoke"].CGColor);//[UIColor colorWithHexString:@"0xcfd4d8"].CGColor);
    CGContextBeginPath(context);
    ...
    //Draw days
    CGContextSetFillColorWithColor(context, [UIColor colorWithName:@"white" ].CGColor);
                                   //[UIColor colorWithHexString:@"0x383838"].CGColor);
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        if (selectedDate && i==selectedDateBlock) {
            ...
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context,  [UIColor colorWithName:@"lightgrey"].CGColor); //[UIColor colorWithHexString:@"0x006dbc"].CGColor);
            CGContextFillPath(context);
            ...
            CGRect rectangleGrid = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context, [UIColor colorWithName:@"red"].CGColor); //[UIColor colorWithHexString:@"0x383838"].CGColor);
            CGContextFillPath(context);
    ...
    for (int i = 0; i<[self.markedDates count]; i++) {
        ...
        //shows manually placed red line under date CP
        int targetBlock = firstWeekDay + (targetDate-1);
        int targetColumn = targetBlock%4;
        int targetRow = targetBlock/4;
        
        int targetX = targetColumn * (kVRGCalendarViewDayWidth+2) + 18;
        int targetY = kVRGCalendarViewTopBarHeight + targetRow * (kVRGCalendarViewDayHeight+2) + 27;
        
        CGRect rectangle = CGRectMake(targetX,targetY,11,1);
        CGContextAddRect(context, rectangle);
...
*/
    ...
    if (self) {
        ...
        labelCurrentMonth.font = [UIFont fontWithName:@"Helvetica Neue" size:16]; //carlos
        labelCurrentMonth.textColor =  [UIColor colorWithName:@"red"];//[UIColor colorWithHexString:@"0x383838"];
        labelCurrentMonth.textAlignment = NSTextAlignmentCenter; //UITextAlignmentCenter;
